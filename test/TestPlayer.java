...
public class TestPlayer {
    ...
    public void TestDrawDiscardPreferredCard() {
        ...
        Player p1 = new Player(left, right, startingHand, 1, new WinHandler());
        // draw & discard
        p1.drawDiscard();
    ...
    public void TestExternalWinEvent() throws InterruptedException, IOException {
        ...
        Player p1 = new Player(left, right, startingHand, 1, winHandler);
        Player p2 = new Player(null, null, new Card[]{new Card(0), new Card(0), new Card(0), new Card(0)}, 2, winHandler);
    ...
    public void TestLogExternalWin() throws InterruptedException, IOException {
        ...
        WinHandler winHandler = new WinHandler();
        Player p1 = new Player(left, right, startingHand, 1, winHandler);
        Player p2 = new Player(null, null, new Card[]{new Card(0),
                new Card(0), new Card(0), new Card(0)}, 2, winHandler);
